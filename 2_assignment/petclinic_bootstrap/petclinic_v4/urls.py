...
urlpatterns = [
    ...
    path('petclinic/owners/add/', views.add_owner),
    path('petclinic/owners/edit/<int:owner_id>/', views.edit_owner),  
    path('petclinic/owners/update/<int:owner_id>/', views.update_owner),
